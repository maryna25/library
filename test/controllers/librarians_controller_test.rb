...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference('Librarian.count') do
      post librarians_url, params: { librarian: { address: @librarian.address, email: @librarian.email, name: @librarian.name, passport_code: @librarian.passport_code, phone_number: @librarian.phone_number, surname: @librarian.surname } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { address: @librarian.address, email: @librarian.email, name: @librarian.name, passport_code: @librarian.passport_code, phone_number: @librarian.phone_number, surname: @librarian.surname } }
